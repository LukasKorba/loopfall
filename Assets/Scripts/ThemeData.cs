...
public class ThemeData
{
    ...
    public static ThemeData SolarFlare() => new ThemeData
    {
        ...
        gateFrontColor    = new Color(1.0f, 0.45f, 0.05f),
        gateFrontEmission = new Color(0.9f, 0.3f, 0.02f),
        gateTopColor      = new Color(1.0f, 0.7f, 0.15f),
        gateTopEmission   = new Color(1.0f, 0.5f, 0.05f),
    ...
    public static ThemeData DeepAbyss() => new ThemeData
    {
        ...
        gateFrontColor    = new Color(0.1f, 0.8f, 0.6f),
        gateFrontEmission = new Color(0.05f, 0.5f, 0.35f),
        gateTopColor      = new Color(0.2f, 0.9f, 0.7f),
        gateTopEmission   = new Color(0.1f, 0.6f, 0.4f),
    ...
    public static ThemeData Synthwave() => new ThemeData
    {
        ...
        gateFrontColor    = new Color(1.0f, 0.35f, 0.65f),
        gateFrontEmission = new Color(0.8f, 0.15f, 0.45f),
        gateTopColor      = new Color(1.0f, 0.55f, 0.75f),
        gateTopEmission   = new Color(0.9f, 0.3f, 0.55f),
    ...
    public static ThemeData ArcticVoid() => new ThemeData
    {
        ...
        gateFrontColor    = new Color(0.7f, 0.9f, 1.0f),
        gateFrontEmission = new Color(0.4f, 0.6f, 0.8f),
        gateTopColor      = new Color(0.85f, 0.95f, 1.0f),
        gateTopEmission   = new Color(0.55f, 0.75f, 0.9f),
    ...
    public static ThemeData Terminal() => new ThemeData
    {
        ...
        sparkColor3    = new Color(0.2f, 0.9f, 0.4f),
        gateFrontColor    = new Color(0.1f, 0.85f, 0.2f),
        gateFrontEmission = new Color(0.05f, 0.55f, 0.1f),
        gateTopColor      = new Color(0.15f, 1.0f, 0.3f),
        gateTopEmission   = new Color(0.08f, 0.7f, 0.15f),
    ...
    public static ThemeData Bloodline() => new ThemeData
    {
        ...
        gateFrontColor    = new Color(0.9f, 0.1f, 0.15f),
        gateFrontEmission = new Color(0.65f, 0.04f, 0.08f),
        gateTopColor      = new Color(1.0f, 0.2f, 0.25f),
        gateTopEmission   = new Color(0.8f, 0.1f, 0.12f),
    ...
    public static ThemeData Gilded() => new ThemeData
    {
        ...
        gateFrontColor    = new Color(1.0f, 0.8f, 0.25f),
        gateFrontEmission = new Color(0.8f, 0.55f, 0.1f),
        gateTopColor      = new Color(1.0f, 0.9f, 0.45f),
        gateTopEmission   = new Color(0.9f, 0.7f, 0.2f),
